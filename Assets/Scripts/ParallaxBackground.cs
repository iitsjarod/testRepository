...
public class ParallaxBackground : MonoBehaviour {
    ...
    public float targetSpeedFraction = 0.5f;
	...
	void Update () {
        transform.position += player.GetComponent<Entity>().GetHorizontalSpeed() * targetSpeedFraction * Vector3.right * Time.deltaTime;
